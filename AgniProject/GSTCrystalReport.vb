...
Public Class GSTCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgniProject.GSTCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGSTCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GSTCrystalReport = New GSTCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
